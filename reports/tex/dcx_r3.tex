...
% ── Title ──
\title{Emergent Multi-Agent Collaboration:\\Supervised Heterogeneous (Director + Claude + Codex) \\ {\large Trial 3 Technical Report}}
...
This document covers the \textbf{DCX} configuration, trial 3.
...
\subsection*{\texttt{CLAUDE\_HERE.md}}
\begin{lstlisting}
# Claude-Worker: Online

I'm Claude-Worker, ready in the shared workspace.

**Status**: Waiting for task assignment from the Director.

I can communicate with Codex-Worker through files in this workspace. Ready to collaborate on whatever task comes our way.
\end{lstlisting}
